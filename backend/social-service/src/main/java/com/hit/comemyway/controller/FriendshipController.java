...
public class FriendshipController {
  ...
  @Operation(summary = "Gửi yêu cầu kết bạn", description = "UserRef gửi kết bạn cho người khác")
  ...
  @Operation(summary = "Lấy danh sách chờ kết bạn",
      description = "UserRef có thể lấy danh sách chờ kết bạn")
  ...
  @Operation(summary = "Accept lời mời kết bạn",
      description = "UserRef có thể đồng ý lời mời kết bạn")
  ...
  @Operation(summary = "Reject lời mời kết bạn",
      description = "UserRef có thể từ chối lời mời kết bạn")
  ...
  @Operation(summary = "Lấy danh sách bạn bè",
      description = "UserRef có thể lấy danh sách bạn bè của mình")
